...
var array=[];
        for(let i=0;i<allAudio.length;i++)
        {
            ...
            let a={"track":i+1,"name":allAudio[i]['audioname'],"duration": allAudio[i]['duration'],"file":allAudio[i]['audiofile'],"id":allAudio[i]['id']}
            ...
            buildPlaylist = $.each(tracks, function(key, value) {
                ...
                $('#plList').append('<li> \
                    <div class="plItem"> \
                        ...
                        <a href="/deleteaudio/'+trackid+'" class="pldelete"><img src="/Images/delete.png"/ width="20"></a> \
                    </div> \
                </li>');
            }),
